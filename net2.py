...
numbers_url = 'https://api.myluckynet.com/v2/phone'
...
async def refresh_phone_number(session, phone):
    refresh_url = f'https://api.myluckynet.com/v2/refresh/?phone={phone}'
...
async def process_api_requests_for_db(db_id):
    ...
    api_url = f"https://api.myluckynet.com/v2/get/?r={db_id}"
